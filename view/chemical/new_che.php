<h1 class="page-header">
    <?php echo $alm->id != null ? $alm->login : 'New Chemical'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="index.php?c=Chemical">Chemical</a></li>
  <li class="active"><?php echo $alm->id != null ? $alm->login : 'New Chemical'; ?></li>
</ol>
     <!--init panel chemical -->       

     <form id="frm-chemical" action="index.php?c=Chemical&a=Guardar" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo $alm->id; ?>" />
    
          <div class="form-group">
               <label>Name Chemical</label>
               <input type="text" name="name_chemical" value="<?php echo $alm->name_chemical; ?>" class="form-control" placeholder="Enter the name Chemical" data-validacion-tipo="requerido" />        
          </div>
