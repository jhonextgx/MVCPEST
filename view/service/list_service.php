...
<div class="well well-sm text-right">
    <a id="newChemical" class="btn btn-primary" href="index.php?c=Service&a=NewService" >New Service type</a>
</div>
...
<table id="example" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
	...
	<tbody>
      ...
      <tr>
			  ...
			  <td align="center"><a href='index.php?c=Service&a=edit&id=<?php echo $r->id; ?>'><span class="glyphicon glyphicon-pencil"></span></a> - <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="index.php?c=Chemical&a=Eliminar&id=<?php echo $r->id; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>									
		    </tr>
		<?php endforeach; ?>        	                
	</tbody>
	<tfoot>
